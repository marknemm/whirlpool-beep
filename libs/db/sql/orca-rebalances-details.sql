SELECT
  ...
  ,TO_CHAR(open_tx.created_at::timestamp at time zone 'GMT-4', 'MM/DD HH:MI AM')  AS opened
  ,TO_CHAR(close_tx.created_at::timestamp at time zone 'GMT-4', 'MM/DD HH:MI AM') AS closed
...
ORDER BY close_tx.created_at DESC;
